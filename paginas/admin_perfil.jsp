<%-- =========================================================================
  admin_perfil.jsp - Perfil do Administrador
  Autor: Tiago Pires
  Data: 2025/2026
  Descricao: Permite ao administrador visualizar e editar os seus dados
             pessoais e alterar a password. Funcionalidade identica ao
             perfil do funcionario mas com layout admin.
...
<div class="grid-2">
    ...
    <div class="card">
        ...
        <form method="post" action="admin_perfil.jsp">
            ...
            <div class="form-group">
                <label for="password_confirmar">Confirmar: *</label>
